...
// Type: Ph2.USBClass
// Assembly: DrFones, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null
// MVID: 2CFE716D-042A-439E-8864-B87487BF64D1
// Assembly location: C:\Mac\Home\Desktop\Dr Fones\DrFones.exe
...
public class USBClass
{
  ...
  public bool IsQueryHooked => !(this.deviceEventHandle == IntPtr.Zero);
  ...
  public static bool GetUSBDevice(
    string VID,
    uint PID,
    ref List<USBClass.DeviceProperties> ListOfDP,
    bool GetCOMPort,
    uint? MI = null)
  {
    IntPtr num1 = Marshal.AllocHGlobal(1024 /*0x0400*/);
    ...
    try
    {
      ...
      string lowerInvariant1 = ("VID_" + VID.ToString()).ToLowerInvariant();
      if (MI.HasValue)
      ...
      if (num2.ToInt32() != -1)
      {
        ...
        while (flag)
        {
          USBClass.Win32Wrapper.WinErrors lastWin32Error;
          if (flag)
          {
            uint RequiredSize = 0;
            ...
            if (flag)
            {
              ...
              if (Marshal.GetLastWin32Error() == 122 && RequiredSize <= 1024U /*0x0400*/ && USBClass.Win32Wrapper.SetupDiGetDeviceRegistryProperty(num2, ref DeviceInfoData, 1U, ref PropertyRegDataType, num1, 1024U /*0x0400*/, ref RequiredSize))
              {
                ...
                if (lowerInvariant2.Contains(lowerInvariant1) && (MI.HasValue && lowerInvariant2.Contains(str) || !MI.HasValue && !lowerInvariant2.Contains("mi")))
                {
                  ...
                  if (USBClass.Win32Wrapper.SetupDiGetDeviceRegistryProperty(num2, ref DeviceInfoData, 12U, ref PropertyRegDataType, num1, 1024U /*0x0400*/, ref RequiredSize))
                    deviceProperties.FriendlyName = Marshal.PtrToStringAuto(num1);
                  deviceProperties.DeviceType = string.Empty;
                  if (USBClass.Win32Wrapper.SetupDiGetDeviceRegistryProperty(num2, ref DeviceInfoData, 25U, ref PropertyRegDataType, num1, 1024U /*0x0400*/, ref RequiredSize))
                    deviceProperties.DeviceType = Marshal.PtrToStringAuto(num1);
                  deviceProperties.DeviceClass = string.Empty;
                  if (USBClass.Win32Wrapper.SetupDiGetDeviceRegistryProperty(num2, ref DeviceInfoData, 7U, ref PropertyRegDataType, num1, 1024U /*0x0400*/, ref RequiredSize))
                    deviceProperties.DeviceClass = Marshal.PtrToStringAuto(num1);
                  deviceProperties.DeviceManufacturer = string.Empty;
                  if (USBClass.Win32Wrapper.SetupDiGetDeviceRegistryProperty(num2, ref DeviceInfoData, 11U, ref PropertyRegDataType, num1, 1024U /*0x0400*/, ref RequiredSize))
                    deviceProperties.DeviceManufacturer = Marshal.PtrToStringAuto(num1);
                  deviceProperties.DeviceLocation = string.Empty;
                  if (USBClass.Win32Wrapper.SetupDiGetDeviceRegistryProperty(num2, ref DeviceInfoData, 13U, ref PropertyRegDataType, num1, 1024U /*0x0400*/, ref RequiredSize))
                    deviceProperties.DeviceLocation = Marshal.PtrToStringAuto(num1);
                  deviceProperties.DevicePath = string.Empty;
                  if (USBClass.Win32Wrapper.SetupDiGetDeviceRegistryProperty(num2, ref DeviceInfoData, 35U, ref PropertyRegDataType, num1, 1024U /*0x0400*/, ref RequiredSize))
                    deviceProperties.DevicePath = Marshal.PtrToStringAuto(num1);
                  deviceProperties.DevicePhysicalObjectName = string.Empty;
                  if (USBClass.Win32Wrapper.SetupDiGetDeviceRegistryProperty(num2, ref DeviceInfoData, 14U, ref PropertyRegDataType, num1, 1024U /*0x0400*/, ref RequiredSize))
                    deviceProperties.DevicePhysicalObjectName = Marshal.PtrToStringAuto(num1);
                  deviceProperties.DeviceDescription = string.Empty;
                  if (USBClass.Win32Wrapper.SetupDiGetDeviceRegistryProperty(num2, ref DeviceInfoData, 0U, ref PropertyRegDataType, num1, 1024U /*0x0400*/, ref RequiredSize))
                  ...
                  if (GetCOMPort)
                  {
                    ...
                    if (hKey.ToInt32() == -1)
                    {
                      lastWin32Error = (USBClass.Win32Wrapper.WinErrors) Marshal.GetLastWin32Error();
                      break;
                    }
                    uint lpType = 0;
                    StringBuilder lpData = new StringBuilder(1024 /*0x0400*/);
                  ...
                  if (deviceProperties.DeviceClass == "Modem" && deviceProperties.DeviceManufacturer.Contains("SAMSUNG Electronics Co., Ltd."))
                    ListOfDP.Add(deviceProperties);
                }
              }
            }
          }
  ...
  public static bool GetUSBDeviceByCOM(
    string VID,
    uint PID,
    ref List<string> ListOfDP,
    bool GetCOMPort,
    uint? MI = null)
  {
    IntPtr num1 = Marshal.AllocHGlobal(1024 /*0x0400*/);
            ...
            if (flag)
            {
              ...
              if (Marshal.GetLastWin32Error() == 122 && RequiredSize <= 1024U /*0x0400*/ && USBClass.Win32Wrapper.SetupDiGetDeviceRegistryProperty(num2, ref DeviceInfoData, 1U, ref PropertyRegDataType, num1, 1024U /*0x0400*/, ref RequiredSize))
              {
                ...
                if (lowerInvariant2.Contains(lowerInvariant1) && (MI.HasValue && lowerInvariant2.Contains(str) || !MI.HasValue && !lowerInvariant2.Contains("mi")))
                {
                  ...
                  if (deviceProperties.DeviceClass == "Modem" && deviceProperties.DeviceManufacturer.Contains("SAMSUNG Electronics Co., Ltd."))
                    ListOfDP.Add(deviceProperties.COMPort);
                }
              }
            }
          }
  ...
  ~USBClass() => this.RegisterForDeviceChange(false, IntPtr.Zero);
  ...
  private class Win32Wrapper
  {
    ...
    public static extern bool SetupDiEnumDeviceInterfaces(
      ...
      uint memberIndex,
      ref USBClass.Win32Wrapper.SP_DEVICE_INTERFACE_DATA deviceInterfaceData);

    [DllImport("setupapi.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern bool SetupDiGetDeviceInterfaceDetail(
      IntPtr hDevInfo,
      ref USBClass.Win32Wrapper.SP_DEVICE_INTERFACE_DATA deviceInterfaceData,
      ref USBClass.Win32Wrapper.SP_DEVICE_INTERFACE_DETAIL_DATA deviceInterfaceDetailData,
    ...
    {
      [FieldOffset(0)]
      public int dbch_size = Marshal.SizeOf(typeof (USBClass.Win32Wrapper.DevBroadcastDeviceInterfaceBuffer));
      [FieldOffset(4)]
