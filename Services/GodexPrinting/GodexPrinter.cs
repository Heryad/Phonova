...
namespace EzioDll
{
    ...
    public class clsPrinterCommand
    {
        ...
        {
            Console.WriteLine($"[GODEX PRINTER] Sending Command: {Cmd}");
            Debug.WriteLine($"[GODEX PRINTER] Sending Command: {Cmd}");
            int result = EZioApi.sendcommand(Cmd);
            Console.WriteLine($"[GODEX PRINTER] Command result: {result}");
            Debug.WriteLine($"[GODEX PRINTER] Command result: {result}");
            return result;
        }
    ...
    public class GodexPrinter
    {
        ...
        public static List<string> GetPrinter_USB()
        {
            ...
            {
                Console.WriteLine($"[GODEX PRINTER] Exception in GetPrinter_USB: {ex.Message}");
                Debug.WriteLine($"[GODEX PRINTER] Exception in GetPrinter_USB: {ex.Message}");
        ...
        {
            Console.WriteLine($"[GODEX PRINTER] OpenUSB called with: {PortName}");
            Debug.WriteLine($"[GODEX PRINTER] OpenUSB called with: {PortName}");
            int result = EZioApi.OpenUSB(PortName);
            Console.WriteLine($"[GODEX PRINTER] OpenUSB result: {result}");
            Debug.WriteLine($"[GODEX PRINTER] OpenUSB result: {result}");
        }
        ...
        public void Close()
        {
            Console.WriteLine("[GODEX PRINTER] Closing port.");
            Debug.WriteLine("[GODEX PRINTER] Closing port.");
            EZioApi.closeport();
        }
