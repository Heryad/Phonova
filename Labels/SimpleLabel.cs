...
namespace Dyagnoz_Latest
{
    public class SimpleLabel : XtraReport
    {
            ...
            bool isSynced = true)
        {
            ...
            shapeCircle.LocationFloat = new PointFloat(126f, 16f);
            shapeCircle.SizeF = new SizeF(24f, 24f);
            ...
            lblCheck.Text = "✔";
            lblCheck.Font = new Font("Tahoma", 10f, FontStyle.Regular);
            lblCheck.LocationFloat = new PointFloat(126f, 16f);
            lblCheck.SizeF = new SizeF(24f, 24f);
            ...
            lblVerified.LocationFloat = new PointFloat(0f, 46f);
            ...
            lblPhone.Font = new Font("Tahoma", 20f, FontStyle.Bold);
            lblPhone.LocationFloat = new PointFloat(0f, 62f);
            lblPhone.SizeF = new SizeF(276f, 34f);
            ...
            lblStatus.LocationFloat = new PointFloat(0f, 100f);
            ...
            sepLine.LocationFloat = new PointFloat(24f, 126f);
            ...
            vLine1.LocationFloat = new PointFloat(100f, 138f);
            ...
            vLine2.LocationFloat = new PointFloat(176f, 138f);
            ...
            // Col 1: IMEI
            XRLabel lblImeiTitle = new XRLabel { Text = "IMEI:", Font = new Font("Tahoma", 5.5f), LocationFloat = new PointFloat(24f, 138f), SizeF = new SizeF(72f, 12f), TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft, Borders = BorderSide.None };
            XRLabel lblImeiVal = new XRLabel { Text = imei, Font = new Font("Tahoma", 7.5f), LocationFloat = new PointFloat(24f, 150f), SizeF = new SizeF(74f, 14f), TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft, Borders = BorderSide.None };
            
            // Col 2: Battery
            XRLabel lblBatTitle = new XRLabel { Text = "BATTERY:", Font = new Font("Tahoma", 5.5f), LocationFloat = new PointFloat(104f, 138f), SizeF = new SizeF(68f, 12f), TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter, Borders = BorderSide.None };
            XRLabel lblBatVal = new XRLabel { Text = battery ?? "-", Font = new Font("Tahoma", 7.5f), LocationFloat = new PointFloat(104f, 150f), SizeF = new SizeF(68f, 14f), TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter, Borders = BorderSide.None };
            
            // Col 3: Warranty
            XRLabel lblWarTitle = new XRLabel { Text = "WARRANTY:", Font = new Font("Tahoma", 5.5f), LocationFloat = new PointFloat(180f, 138f), SizeF = new SizeF(72f, 12f), TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter, Borders = BorderSide.None };
            string warText = string.IsNullOrEmpty(s.WarrantyText) ? "30 DAYS" : s.WarrantyText.ToUpper();
            XRLabel lblWarVal = new XRLabel { Text = warText, Font = new Font("Tahoma", 7.5f), LocationFloat = new PointFloat(180f, 150f), SizeF = new SizeF(72f, 14f), TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter, Borders = BorderSide.None };
