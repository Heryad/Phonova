...
namespace Phonova
{
    public class ElmougyLabel : XtraReport
    {
        ...
        private void InitializeComponent()
        {
            ...
            string logoPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Assets", "Company", "elmougy.png");
            ...
            // ── Table geometry ────────────────────────────────────────
            float tableX = 5f;
            float tableY = productY + 27f;
            float col1W = 132.5f;
            float col2W = 132.5f;
            float rowH = 14f;
            float tableW = col1W + 1f + col2W;
            float tableH = 104f;
